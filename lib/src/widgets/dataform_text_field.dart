...
/// A TextField that can be used inside a [DataForm] to save its value
/// in a [Map<String, dynamic>].+
///
...
class DataFormTextField<T> extends StatelessWidget {
  ...
  /// The mode to use to validate entries in this form
  /// if autovalidation is enabled.
  ...
  /// showing when it is tapped by
  /// calling [EditableTextState.requestKeyboard()].
  ...
  ///
  /// If null, defaults to the `titleMedium` text
  /// style from the current [Theme].
  ...
  ///
  /// The text field enforces the length with
  /// a [LengthLimitingTextInputFormatter], which is evaluated after the
  ...
  ///
  /// If this property is null, [MaterialStateMouseCursor.textable] will
  /// be used.
  ///
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      onSaved: (newValue) {
        ...
        dataForm?.saveField(
          id: id,
          value: formatter?.call(newValue) ?? newValue,
